...
% research questions
\AfterEndPreamble{
    \newcommand{\rqOne}{\textbf{\gls{rq}1}: \textit{How can research-related data (e.g., publications, topics, affiliations) be modeled into a \gls{kg} for research collaborator recommendation?}}
    ...
    \newcommand{\rqFour}{\textbf{\gls{rq}4}: \textit{How accurate and effective is the proposed sysetem in retrieveing relevant information about research projects and providing personalized research collaborator recommendations?}}
}
\begin{document}
...
\fillingPage{}
\input{chapters/Knowledge-DrivenArchitecture.tex}
\fillingPage{}
\input{chapters/ArtifactDevelopment.tex}
\fillingPage{}
