...
\input{01_Chapters/research-design/research-philosophy.tex}
%
\section{Research Approach}\label{sec:research-approach}
\input{01_Chapters/research-design/research-approach.tex}
%
\section{Methodological Choice}\label{sec:methodological-choice}
\input{01_Chapters/research-design/methodological_choice.tex}
%
\section{Research Strategy}\label{sec:research-strategy}
\input{01_Chapters/research-design/research-strategy.tex}
%
\section{Time Horizon}\label{sec:time-horizon}
\input{01_Chapters/research-design/time-horizon.tex}
%
\section{Data Collection and Data Analysis}\label{sec:data-collectiom-and-data-analysis}
\input{01_Chapters/research-design/data-collection-and-data-analysis.tex}