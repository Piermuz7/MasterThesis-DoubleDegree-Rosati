...
\acrlongpl{gnn} have become a cornerstone in the realm of deep learning, particularly for tasks involving non-Euclidean data structures. These models have significantly impacted various domains, such as social network analysis, bioinformatics, recommendation systems, and \gls{nlp}. This literature review explores the development, key architectures, methodologies, applications, challenges, and future directions of \glspl{gnn}.
